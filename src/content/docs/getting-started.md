...
description: Install S.O.K, take a tour of the interface and organize your first folder.
order: 1
---

S.O.K (Storage Organisation Kit) identifies your media files using online databases, then renames and moves them into a clean library that works with Plex, Jellyfin and Kodi.
...
- **Sidebar (left)**: lets you move between pages. Click the menu icon at the top to collapse or expand it.
  - **Library**: *Home*, *TV Shows*, *Movies*, *Music*, *Books*, *Games*
  - **General**: *Settings*
- **Main area (right)**: the page you selected.
...
The quickest way to see S.O.K in action is a TV series:

1. Open **TV Shows** in the sidebar.
2. **Drag and drop** the folder with your episodes onto **Source folders**, or click it to browse.
3. S.O.K guesses the series name from the first file and starts a search on its own. If the first result is wrong, type another name and click the right result.
...
- [TV shows](/docs/tv-shows): series, seasons and episodes
- [Movies](/docs/movies): rename a whole folder of movies at once
- [Music, books and games](/docs/music-books-games)
- [Settings](/docs/settings): theme, language, name formats, API keys
